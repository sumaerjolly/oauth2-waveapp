# Wave App Online Provider for OAuth 2.0 Client
...
```
composer require sumaerjolly/oauth2-wave
```

### Usage

Usage is the same as The League's OAuth client, using `\Sumaerjolly\OAuth2\Client\Provider\Wave` as the provider.

### Authorization Code Flow

```php
$provider = new Sumaerjolly\OAuth2\Client\Provider\Wave([
    'clientId'          => '{wave-app-id}',
    'clientSecret'      => '{wave-app-secret}',
...
At the time of authoring this documentation, the [following scopes are available](https://developers.wave.com/docs/oauth).
